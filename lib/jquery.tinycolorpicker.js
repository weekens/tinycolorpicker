(function($) {
  ...
  var defaults = {
    colors: ["#ffffff", "#A7194B", "#FE2712", "#FB9902", "#FABC02", "#FEFE33", "#D0EA2B", "#66B032", "#0391CE",
      "#0247FE", "#3D01A5", "#8601AF"],
    backgroundUrl: null
  };
  ...
  function Plugin($container, options) {
    ...
    var $canvas = null;
    var $colorInput = $container.find(".colorInput");
    var $dropdown = $container.find(".dropdown");
    var $dropdownItem = $dropdown.find("li").remove();
    var context = null;
    ...
    function initialize() {
      ...
      inputVal && $color.find(".colorInner").css("backgroundColor", inputVal);
    ...
    function setImage() {
      ...
      var backgroundUrl = $track.css("background-image").replace(/"/g, "").replace(/url\(|\)$/ig, "");
